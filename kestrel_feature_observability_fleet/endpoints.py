...
def get_router(store_provider: Callable[[], Optional[FleetObservabilityStore]]) -> Any:
    ...
    async def stream(request: Request) -> Any:
        ...
        generator = event_stream(
            store, last_event_id=last_event_id, session_id=session_id
        )
